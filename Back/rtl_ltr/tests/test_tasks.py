...
class ViewTests(TestCase):
    ...
    def test_get_questionnaires_table_task(self):
    ...
    @pytest.mark.django_db
    def test_get_questionnaire_task(self):
        q = Questionnaire.objects.all()
        questionnaires = QuestionnaireSerializer(q, many=True).data
        for i, quest in enumerate(questionnaires):
    ...
    @pytest.mark.django_db
    def test_questionnaire_by_hosted_link_task(self):
    ...
    @pytest.mark.django_db
    def test_delete_task_from_questionnaire_task(self):
    ...
    @pytest.mark.django_db
    def test_get_preview_data_task(self):
        q = Questionnaire.objects.all()
        questionnaires = QuestionnaireSerializer(q, many=True).data
        for i, quest in enumerate(questionnaires):
    ...
    @pytest.mark.django_db
    def test_insert_questionnaire_tasks_task(self):
        q = Questionnaire.objects.all()
        questionnaires = QuestionnaireSerializer(q, many=True).data
        max_quest_id = 0
        for i, quest in enumerate(questionnaires):
    ...
    @pytest.mark.django_db
    def test_update_questionnaire_tasks_task(self):
        q = Questionnaire.objects.all()
        questionnaires = QuestionnaireSerializer(q, many=True).data
    ...
    @pytest.mark.django_db
    def test_delete_questionnaire_tasks_task(self):
        data = {'tasks': [],
                'creation_date': '2021-01-06 23:25',
                'questionnaire_name': 'sad',
                'direction': 'RTL',
    ...
    @pytest.mark.django_db
    def test_insert_participant_data_task(self):
        q = Questionnaire.objects.all()
        questionnaires = QuestionnaireSerializer(q, many=True).data
    ...
    @pytest.mark.django_db
    def test_get_csv_data_task(self):
        q = Questionnaire.objects.all()
        questionnaires = QuestionnaireSerializer(q, many=True).data
    ...
    @pytest.mark.django_db
    def test_insert_participant_task_data_task(self):
        serializer = ParticipantSerializer(data={})
        if serializer.is_valid():
            serializer.save()
        p_id = serializer.data['participant_id']
