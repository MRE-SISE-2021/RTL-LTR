...
class Input extends React.Component {
  render() {
    ...
    const html = `<h3>Welcome to our Experiment: </h3>
        <figure class="image image-style-side">
            <img alt="Picture of the Warsaw Old Town." src="https://previews.123rf.com/images/foxysgraphic/foxysgraphic1802/foxysgraphic180200015/95357657-welcome-banner-speech-bubble-poster-and-sticker-concept-memphis-geometric-style-with-text-welcome-ic.jpg" />
